    ...
    <>
      <div className="claim-grid__wrapper">
        <h1 className="claim-grid__header">
          <Link className="button button--link" to="/finance">
            <span className="button__content">
              <span className="icon__wrapper icon__wrapper--DollarSign">
                <svg
                  ...
                  className="icon icon--DollarSign claim-grid__header-icon"
              ...
              <span className="claim-grid__title">Finance 2.0</span>
            </span>
          </Link>
        </h1>
