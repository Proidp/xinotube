      ...
      <div className="card__first-pane">
        <div className="card__header--between">
          <div className="card__title-section">
            <div>
              <h2 className="card__title">Privacy Policy</h2>
            </div>
          </div>
        ...
        <div className="card__body">
          <div>
            ...
            <p> As part of Xinotube YouTube Sync Verification, we will only use read-only access to verify the ownership of YouTube channels and will not transfer this data to others unless doing so is necessary to comply with applicable law, or as part of a merger, acquisition, or sale of assets.</p>
            <p>Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. <code>https://support.google.com/adwordspolicy/answer/1316548?hl=en</code>
            </p>
            ...
            <blockquote>
              <p>Xinotube Inc. 99 Hanover St Manchester, New Hampshire 03101 United States hello@Xinotube.com</p>
            </blockquote>
