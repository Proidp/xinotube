  ...
  return (
      ...
      <div className="claim-grid__wrapper">
        <h1 className="claim-grid__header">
          <Link className="button button--link" to="/tech">
          <span className="button__content">
            <span className="icon__wrapper icon__wrapper--Speaker">
              <svg size="20" className="icon icon--Speaker claim-grid__header-icon"  xmlns="http://www.w3.org/2000/svg" viewBox="-5 0 24 24" width="20" height="20" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <span className="claim-grid__title">Tech</span>
          </span>
          </Link>
        </h1>
