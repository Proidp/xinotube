...
const TermsServceInner = () => {
      ...
      <div className="card__first-pane">
        <div className="card__header--between">
          <div className="card__title-section">
            <div>
              <h2 className="card__title">Terms of Service</h2>
            </div>
          </div>
        ...
        <div className="card__body">
          <div>
            ...
            <p>
              <strong>PLEASE READ THESE TERMS OF SERVICE CAREFULLY. NOTE THAT SECTION 16 CONTAINS A BINDING ARBITRATION CLAUSE AND className ACTION WAIVER, WHICH AFFECT YOUR LEGAL RIGHTS. IF YOU DO NOT AGREE TO THESE TERMS OF SERVICE, DO NOT ACCESS OR USE THE SERVICES.</strong>
            </p>
            <p>By clicking to agree to these Terms of Service ( <strong>“Terms"</strong>) when running/installing our software, publishing content to Xinotube, or by otherwise accessing or using the network [via proxy or direct], mobile applications and online services (collectively, our <strong>“Services"</strong>) of Xinotube Inc. ( <strong>“Company," “we," or “us"</strong>), you agree to be bound by these Terms. If you do not agree to these Terms, you may not access or use the Services for any purpose. Please refer to our Privacy Policy https://Xinotube.com/$/privacypolicy for information about how we collect, use and disclose information about you. </p>
            <p>You and the Company agree as follows:</p>
            <h3 id="toc_0">1. Overview of Xinotube and the Services</h3>
            <p>
              <strong>Xinotube"</strong> is a decentralized, consensus-driven protocol that enables the publication and viewing of information, videos, music, data and other materials ( <strong>“Content"</strong>). Content is distributed to Xinotube by publishers and is stored in fragmented shards via a distributed network of third-party devices ( <strong>“Hosts"</strong>) that utilize Xinotube. Xinotube also allows publishers to bid on and reserve names ( <strong>“Names"</strong>), which can be used as a unique identifier for Content. Please consult Xinotube.tech to learn more about the technical architecture of Xinotube.
            </p>
            <p>The Services provide an interface for you to interact with Xinotube, including to publish, access, or host Content through Xinotube. The Xinotube protocol is not owned, operated, or maintained by us. We have no responsibility or liability for Xinotube, and the Company has no ability to control third parties’ use of Xinotube. We are not able to delete or remove Content that has been published through Xinotube and that may be accessible via the Services. </p>
            ...
            <p>This section applies if you use the Services to publish Content through Xinotube. </p>
            ...
            <ul>
              <li>is unlawful, for example, copyrighted works, underage sexual content, revenge pornography, or any other content illegal under US or state law.</li>
              ...
              <li>in the sole judgment of the Company, is objectionable or which restricts or inhibits any other person from using or enjoying Xinotube or the Services, or which may expose the Company or its users to any harm or liability of any type.</li>
              <li>USD equivalent of Xinotube Credits [LBC] is determined by 3rd party markets such as Bittrex and Poloniex, not Xinotube INC.</li>
            </ul>
            <h3 id="toc_3">4. Accessing Content</h3>
            <p>This section applies if you use the Services to access Content that has been stored through Xinotube.</p>
            ...
            <p>c) All payments for content will be made using LBC and occur on the Xinotube blockchain. Purchaser is buying the right to access content for personal non-commercial use unless content creator provides a license for commercial use or remixing.</p>
            <h3 id="toc_4">5. Hosting Content</h3>
            <p>This section applies to you if you host any Content via Xinotube using the Services. The Services allow Hosts to make available storage space ( <strong>“Space"</strong>) on the Host’s device for the storage of Content published through Xinotube By making available Space on your device, you authorize any user of our Services to: (i) store Content published through Xinotube onto your device; and (ii) access such Content from your device at any time. </p>
            ...
            <p>a) If you participate in the YouTube Sync Program, you also agree to <Link to="/terms" rel="noopener">YouTube's Terms of Service (https://www.youtube.com/t/terms)</Link> and <Link to="https://www.google.com/policies/privacy" rel="noopener">Google's Privacy Policy (https://www.google.com/policies/privacy).</Link>
            </p>
            <p>b) To revoke Xinotube's access to your YouTube account or manage your security preferences, please <Link to="/permissions" rel="noopener">refer to your Google Security and Permissions Page (https://security.google.com/settings/security/permissions).</Link>
            </p>
            ...
            <p>Designated Agent: Xinotube INC Address: 99 Hanover St, Manchester, NH 03101 Telephone Number: 907-318-5956 Fax Number: 801-327-6808</p>
            <p>E-Mail Address: hello@Xinotube.com</p>
            ...
            <p>
              <strong>The limitations set forth in this section will not limit or exclude liability for the gross negligence, fraud or intentional misconduct of the Company or other Company Parties or for any other matters in which liability cannot be excluded or limited under applicable law. Additionally, some jurisdictions do not allow the exclusion or limitation of incidental or consequential damages, so the above limitations or exclusions may not apply to you.</strong>
            </p>
            <h3 id="toc_14">15. Release</h3>
            <p>To the fullest extent permitted by applicable law, you release the Company and the other Company Parties from responsibility, liability, claims, demands and damages (actual and consequential) of every kind and nature, known and unknown (including, but not limited to, claims of negligence), arising out of or related to disputes between users and the acts or omissions of third parties. <strong>You expressly waive any rights you may have under California Civil Code § 1542 as well as any other statute or common law principles that would otherwise limit the coverage of this release to include only those claims which you may know or suspect to exist in your favor at the time of agreeing to this release.</strong>
            </p>
            <h3 id="toc_15">16. Dispute Resolution; Arbitration</h3>
            <p>
              <strong>Please read the following section carefully because it requires you to arbitrate certain disputes and claims with the Company and limits the manner in which you can seek relief from us.</strong>
            </p>
            ...
            <h3 id="toc_17">16.2. No className Arbitrations, className Actions or Representative Actions</h3>
            <p>Any Dispute arising out of or related to these Terms or the Services is personal to you and the Company and will be resolved solely through individual arbitration and will not be brought as a className arbitration, className action or any other type of representative proceeding. There will be no className arbitration or arbitration in which an individual attempts to resolve a Dispute as a representative of another individual or group of individuals. Further, a Dispute cannot be brought as a className or other type of representative action, whether within or outside of arbitration, or on behalf of any other individual or group of individuals.</p>
            ...
            <p>Each party will notify the other party in writing of any arbitrable or small claims Dispute within thirty (30) days of the date it arises, so that the parties can attempt in good faith to resolve the Dispute informally. Notice to the Company will be sent by e-mail to the Company at hello@Xinotube.com. Notice to you will be by email to the then-current email address in your Account. Your notice must include (a) your name, postal address, email address and telephone number, (b) a description in reasonable detail of the nature or basis of the Dispute, and (c) the specific relief that you are seeking. If you and the Company cannot agree how to resolve the Dispute within thirty (30) days after the date notice is received by the applicable party, then either you or the Company may, as appropriate and in accordance with this Section 16, commence an arbitration proceeding or, to the extent specifically provided for in Section 17.1, file a claim in court. </p>
            ...
            <p>As limited by the FAA, these Terms and the applicable JAMS rules, the arbitrator will have (a) the exclusive authority and jurisdiction to make all procedural and substantive decisions regarding a Dispute, including the determination of whether a Dispute is arbitrable, and (b) the authority to grant any remedy that would otherwise be available in court; provided, however, that the arbitrator does not have the authority to conduct a className arbitration or a representative action, which is prohibited by these Terms. The arbitrator may only conduct an individual arbitration and may not consolidate more than one individual’s claims, preside over any type of className or representative proceeding or preside over any proceeding involving more than one individual.</p>
            <h3 id="toc_22">16.7. Rules of JAMS</h3>
            <p>The rules of JAMS and additional information about JAMS are available on the <Link to="" rel="noopener">JAMS website.</Link> By agreeing to be bound by these Terms, you either (a) acknowledge and agree that you have read and understand the rules of JAMS, or (b) waive your opportunity to read the rules of JAMS and any claim that the rules of JAMS are unfair or should not apply for any reason. </p>
  ...
  <footer className="footer">
    <ul className="navigation__tertiary footer__links">
      ...
      <li className="footer__link">
        <Link target="_blank" rel="noopener noreferrer" to="https://Xinotube.com/$/tos" className="button button--no-style" aria-label="Terms">
          <span className="button__content">
...
export default TermsServceInner;
