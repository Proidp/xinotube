...
import CommunityGuideInner from '../Components/CommunityGuideInner';
...
const CommunityGuide = () => {
  ...
  return (
      ...
      <header className="header">
          ...
          <div className="navigation__wrapper navigation__wrapper--absolute single-sidebar">
             ...
             <div onClick={ToggleSwitch} className={switchToggled ? "navigation__overlay " : "navigation__overlay navigation__overlay--active"}></div>
          </div>
          <CommunityGuideInner/>
          </div>
      </>
