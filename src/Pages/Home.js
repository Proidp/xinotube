      ...
      <div className="main-wrapper">
        ...
        <div className="main-wrapper__inner">
          <div
            className={
              switchToggled
                ? "navigation__wrapper navigation__wrapper--micro"
                : "navigation__wrapper navigation__wrapper--micro-not-active"
            }
          >
            <nav
              aria-label="Sidebar"
              className={
                switchToggled
                  ? "navigation navigation--push navigation--micro"
            ...
            >
              <div className="navigation-inner-container">
                ...
                <ul className="navigation-links navigation-links--absolute">
                  <li>
                    <Link
                      ...
                      className={
                        switchToggled
                          ? "button button--no-style navigation-link navigation-links--micro"
                          : "button button--no-style navigation-link"
                      }
                      title="Home"
                      aria-label="Home"
                      to="/"
                    ...
                    >
                      <span className="button__content">
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          className="icon icon--Pop Culture"
                    ...
                    >
                      <span className="button__content">
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          className="icon icon--MusicCategory"
                ...
                <div
                  className={
                    switchToggled
                      ? "navigation__auth-nudge sidebar-footer d-none"
                      : "navigation__auth-nudge sidebar-footer"
                  }
                >
                  <span>
                    Sign up to earn{" "}
                    ...
                    >
                      ...
                      <path
                        d="M8.925 10.3688L3.99375 14.8125L7.70625 18.15L12.6375 13.7063L8.925 10.3688Z"
                        fill="url(#paint0_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c)"
                      ></path>
                      <path
                        d="M8.925 10.3688L15.1312 4.80005L12 1.98755L2.60625 10.425V13.575L3.99375 14.8125L8.925 10.3688Z"
                        fill="url(#paint1_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c)"
                      ></path>
                      <path
                        d="M15.075 13.6313L20.0062 9.1876L16.2937 5.8501L11.3625 10.2938L15.075 13.6313Z"
                        fill="url(#paint2_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c)"
                      ></path>
                      <path
                        d="M15.075 13.6312L8.86875 19.2L12 22.0125L21.3937 13.575V10.425L20.0062 9.1875L15.075 13.6312Z"
                        fill="url(#paint3_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c)"
                      ></path>
                      <defs>
                        <linearGradient
                          id="paint0_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c"
                          x1="3.7206"
                          y1="14.2649"
                          x2="15.1645"
                          y2="14.2649"
                        ...
                        <linearGradient
                          id="paint1_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c"
                          x1="2.60274"
                          y1="8.40089"
                          x2="15.14"
                          y2="8.40089"
                        ...
                        <linearGradient
                          id="paint2_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c"
                          x1="6.8682"
                          y1="14.1738"
                          x2="25.405"
                          y2="4.84055"
                        ...
                        <linearGradient
                          id="paint3_linear0faa24b0-f0b0-4923-b2c9-cbbf451eef7c"
                          x1="25.2522"
                          y1="6.08799"
                          x2="3.87697"
                          y2="27.836"
                    ...
                    for you and your favorite creators.{" "}
                  </span>
                  <Link
                    className="button button--secondary"
                    aria-label="Sign Up"
                    to="/signup?src=sidenav_nudge"
                  >
                    <span className="button__content">
                      <span dir="auto" className="button__label">
                        Sign Up
              ...
              <ul
                className={
                  switchToggled
                    ? "navigation__tertiary navigation-links--small sidebar-footer d-none"
                    : "navigation__tertiary navigation-links--small sidebar-footer"
                }
              >
                <li
                  className={
                    switchToggled
                      ? "navigation-link navigation-links--micro"
                      : "navigation-link"
                  }
                >
                  <Link
            ...
            <div
              ...
              className={
                switchToggled
                  ? "navigation__overlay navigation__overlay--active"
                  : "navigation__overlay"
              }
            ></div>
          </div>
